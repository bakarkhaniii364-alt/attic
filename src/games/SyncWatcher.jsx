               ...
               <div className="flex-1 relative flex items-center justify-center">
                   <div className="absolute inset-0 z-0">
                       ...
                       <ReactPlayer 
                           ...
                           onError={(e) => setLoadError('YouTube blocks embeds on localhost due to CSP. Deploy to HTTPS (Vercel/Netlify) to fix. Direct .mp4 links work locally.')}
                           width="100%" 
                           height="100%"
                           style={{ position: 'absolute', top: 0, left: 0 }}
                           config={{ 
                             youtube: { playerVars: { modestbranding: 1, rel: 0, controls: 1 } },
                             file: { attributes: { controls: true } }
                           }}
                       />
                   </div>
