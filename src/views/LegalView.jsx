    ...
    <RetroWindow title="terms_and_privacy.txt" onClose={onClose || (() => navigate(-1))} className="w-full max-w-3xl h-[calc(100dvh-4rem)] max-h-[800px] flex flex-col">
      <div className="flex-1 overflow-y-auto p-6 sm:p-10 bg-white/50 text-[var(--text-main)]">
        <div className="max-w-2xl mx-auto space-y-16">
          ...
          <header className="text-center border-b-4 border-[var(--border)] pb-8">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2"><FileText className="text-[var(--primary)]" /> 1. Agreement to Terms</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2">2. Service Description</h2>
            <p className="text-sm leading-relaxed font-medium">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2">3. Account & Security</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2">4. User Content</h2>
            <div className="space-y-4 text-sm font-medium leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2"><ShieldCheck className="text-[var(--secondary)]" /> 5. Privacy & Deletion</h2>
            <div className="space-y-4 text-sm font-medium leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-black uppercase flex items-center gap-2 border-b-2 border-[var(--border)] pb-2">6. Limitation of Liability</h2>
          ...
          <footer className="pt-10 border-t-2 border-dashed border-[var(--border)] text-center space-y-4">
            <div className="flex justify-center gap-4">
              <a href="mailto:support.attic.app@gmail.com" className="text-xs font-black uppercase underline hover:text-[var(--primary)]">Contact Support</a>
              <a href="https://www.facebook.com/bakarkhaniii/" target="_blank" rel="noreferrer" className="text-xs font-black uppercase underline hover:text-[var(--secondary)] inline-flex items-center gap-1">Developer <ExternalLink size={10} /></a>
            </div>
