...
--
-- Then run supabase/migrations/storage_policies.sql for room-scoped RLS on objects.
-- Then run supabase/migrations/security_hardening.sql (pairing rate limits, highscores RLS).
-- ============================================================
