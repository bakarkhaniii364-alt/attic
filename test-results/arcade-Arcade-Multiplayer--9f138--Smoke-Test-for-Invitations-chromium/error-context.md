...
- Name: arcade.spec.ts >> Arcade Multiplayer Suite >> Invite all games - Smoke Test for Invitations
- Location: tests\arcade.spec.ts:98:3
...
Locator: getByRole('button', { name: /START GAME/i })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /START GAME/i })
